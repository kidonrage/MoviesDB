...
final class MoviesListViewController: UITableViewController {
    ...
    private lazy var playingMoviesCollectionView: UICollectionView = {
    ...
    private let playingMoviesHeaderLabel: UILabel = {
        let label = UILabel()
    ...
    private lazy var playingMoviesView: UIView = {
        let view = UIView(frame: CGRect(x: 0, y: 0, width: self.view.frame.width, height: 180))

        view.addSubview(playingMoviesHeaderLabel)
        view.addSubview(playingMoviesCollectionView)
    ...
    override func viewDidLoad() {
        ...
        tableView.tableHeaderView = playingMoviesView
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        playingMoviesView.frame = CGRect(x: 0, y: 0, width: view.frame.width, height: 180)
        playingMoviesHeaderLabel.frame = CGRect(x: 16, y: 0, width: playingMoviesView.frame.width, height: 30)
        playingMoviesCollectionView.frame = CGRect(
            x: 0,
            y: 30,
            width: playingMoviesView.frame.width,
            height: 134
        )
    }
    ...
    private func didFetchPlayingMovies() {
        playingMoviesCollectionView.reloadData()
    }
